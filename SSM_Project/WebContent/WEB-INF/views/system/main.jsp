...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
	...
	<div class="wu-header" data-options="region:'north',border:false,split:true">
        ...
        <div class="wu-header-right">
        	<p><strong class="easyui-tooltip" title="0条未读消息">开发人员:${admin.username}</strong>，欢迎您！</p>
    	...
    	<div class="easyui-accordion" data-options="border:false,fit:true"> 
        	...
        	<div title="${topMenu.name }" data-options="iconCls:'${topMenu.icon }'" style="padding:5px;">  	
             ...
             <div title="系统设置" data-options="iconCls:'icon-wrench'" style="padding:5px;">
                <ul class="easyui-tree wu-side-tree">
                   <li iconCls="icon-chart-organisation"><a href="javascript:void(0)" data-icon="icon-chart-organisation" data-link="../menu/list" iframe="0">菜单管理</a></li>
                   <li iconCls="icon-group-edit"><a href="javascript:void(0)" data-icon="icon-group-edit" data-link="../role/list" iframe="0">角色管理</a></li>
                </ul>
             </div>
        </div>
    </div>	
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2019 Rant丶 All Rights Reserved
    </div>
    <!-- end of footer -->  

	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="icon" id="add-icon" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写菜单名称'" />
                    <a href="#" class="easyui-linkbutton" iconCls="icon-remove" onclick="selectIcon()" plain="true">选择</a>               
                </td>
            </tr>
        </table>
    </form>
